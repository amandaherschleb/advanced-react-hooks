...
// good practice to keep reducers above providers that they are used in
...
function PokemonSection({onSelect, pokemonName}) {
  //  PokemonCacheProvider gives PreviousPokemon
  // and PokemonInfo components access to that context
  return (
