...
function MessagesDisplay({messages}, ref) {
  ...
  // useImperativeHandle replaces this:
  // React.useOLayoutEffect(() => {
  //   ref.current = {
  //     scrollToTop,
  //     scrollToBottom
  //   }
  ...
  // callback function returns an object with scrollToTop and scrollToBottom
...
// now takes second arg called ref
